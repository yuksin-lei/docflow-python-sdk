...
TRANSLATIONS = {
    ...
    'error.category.extract_model_invalid': 'extract_model must be an ExtractModel member (Auto/Acgpt/Acgpt-VL/DF-M1; legacy Model 1/2/3 still accepted) or the corresponding string',
